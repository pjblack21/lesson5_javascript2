          ...
          *******************************************************************************/
                ...
                if (income <= 18550){
                 ...
                 taxRate = 33;
                  ...
                  tax =18550 * 0.10 + (75300 - 18550)* 0.15 +
                       (151900 - 75300) * 0.25 + (231450 - 151900) * 0.28 +
                        (413350 - 213450) * 0.33 + (income - 413350) * 0.35;
                  taxRate = 35;
               }//end of else if
               else {
                  tax =18550 * 0.10 + (75300 - 18550)* 0.15 +
                       (151900 - 75300) * 0.25 + (231450 - 151900) * 0.28 +
                        (413350 - 213450) * 0.33  + (466950 - 413350 ) * 0.35 + (income - 466950) * .396;
                  taxRate = 39.6;
...
function clearButton () {
             ...
             //INSERT YOUR CODE BELOW
             document.getElementById("taxEstimate").selectedIndex = "";
             document.getElementById("taxBracket").selectedIndex = "";
